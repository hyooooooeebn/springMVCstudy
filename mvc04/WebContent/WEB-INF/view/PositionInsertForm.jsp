		...
		<form action="positioninsert.action" method="post" id="positionForm">
			<table>
				...
				<tr>
					<th>최소기본급</th>
					<td>
						<input type="text" id="minBasicPay" name="minBasicPay" placeholder="최소급여">
					</td>
				</tr>
				...
				<tr>
					<td colspan="2" align="center">
						...
						<button type="button" class="btn" id="listBtn" style="width:40%" onclick="location.href='positionlist.action'">
							직위 리스트
						</button>
						<br><br>
